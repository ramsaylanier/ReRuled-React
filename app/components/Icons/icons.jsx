...
const LogoIcon = <svg version="1.1" className={styles.logo} x="0px" y="0px" viewBox="0 0 200 200" enable-background="new 0 0 200 200">
			<path className="left-r" fill="#F26425" d="M40.1,28.8c0-2.5,2-4.5,4.5-4.5h24.2c2.5,0,4.5,2,4.5,4.5V36c0,2.5,2,4.5,4.5,4.5h33.6
			...
			<path className="right-r" fill="#69CBDB" d="M159.9,171.2c0,2.5-2,4.5-4.5,4.5l-24.2,0c-2.5,0-4.5-2-4.5-4.5V164c0-2.5-2-4.5-4.5-4.5
